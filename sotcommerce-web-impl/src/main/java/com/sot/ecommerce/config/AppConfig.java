...
@Configuration
@ComponentScan(basePackages = { "com.sape.net" }, excludeFilters = {
...
@EnableCaching
@EnableAsync
@EnableJpaRepositories(basePackages = { "com.sape.net.repositories" })
...
public class AppConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factory.setPackagesToScan("com.sape.net.entities");
